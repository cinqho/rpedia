...
export function LeftShape() {
  return (
    <div className="absolute left-0 top-1/2 -translate-y-1/2 w-96 h-64 pointer-events-none">
...
export function RightShape() {
  return (
    <div className="absolute right-0 top-1/2 -translate-y-1/2 w-96 h-64 pointer-events-none">
      <svg viewBox="0 0 350 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
